@extends('admin.master', ['title' => __('Edit Coupon')])

@section('content')
    @include('admin.layout.topHeader', [
        'title' => __('Edit Grocery Coupon') ,
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group{{ $errors->has('code') ? ' has-danger' : '' }}">                                            
                                                    ...
                                                    <input type="text" name="code" id="input-code" class="form-control form-control-alternative{{ $errors->has('code') ? ' is-invalid' : '' }}" placeholder="{{ __('Code') }}" value="{{ $data->code }}" required >
                                                    @if ($errors->has('code'))
                                                        <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="row">
                                                        ...
                                                        <select name="location_id" id="input-location_id" class="form-control form-control-alternative{{ $errors->has('location_id') ? ' is-invalid' : '' }}" required >
                                                            <option value="">{{__("Select Location")}}</option>
                                                                @foreach ($location as $item)
                                                                    <option value="{{$item->id}}"{{$data->location_id==$item->id ? 'Selected' : ''}}>{{$item->name}}</option>    
                                                                @endforeach 
                                                        </select>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group{{ $errors->has('max_use') ? ' has-danger' : '' }}">                                            
                                                    ...
                                                    <input type="number" min="0" name="max_use" id="input-max_use" class="form-control form-control-alternative{{ $errors->has('max_use') ? ' is-invalid' : '' }}" placeholder="{{ __('Maximum Usage') }}" value="{{ $data->max_use }}" required >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <div class="form-group{{ $errors->has('type') ? ' has-danger' : '' }}">                                            
                                                    <div class="row">
                                                        ...
                                                        <div class="col-8">
                                                            <label class="custom-toggle">
                                                                <input type="radio" value="amount" name="type" {{$data->type=='amount' ? 'Checked' : ''}}>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-8">
                                                            <label class="custom-toggle">
                                                                <input type="radio" value="percentage" name="type"  {{$data->type=='percentage' ? 'Checked' : ''}}>
                                                                <span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group{{ $errors->has('discount') ? ' has-danger' : '' }}">                                            
                                                    ...
                                                    <input type="number" min="0" name="discount" id="input-discount" class="form-control form-control-alternative{{ $errors->has('discount') ? ' is-invalid' : '' }}" placeholder="{{ __('Discount') }}" value="{{ $data->discount }}" required >
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group{{ $errors->has('start_date') ? ' has-danger' : '' }}">                                            
                                                    ...
                                                    <input type="text" name="start_date" id="coupon_start_date" class="form-control form-control-alternative{{ $errors->has('start_date') ? ' is-invalid' : '' }}" placeholder="{{ __('Activate Date') }}" value="{{$data->start_date.' to '.$data->end_date}}" required style="background:#fff;" >
