@extends('admin.master', ['title' => __('Edit Location')])
            ...
            <div class="row">
                    <div class="col-xl-12 order-xl-1">
                        <div class="card form-card bg-secondary shadow">
                            ...
                            <div class="card-body">
                                <form method="post" action="{{url('Location/'.$data->id)}}" autocomplete="off" >
                                    @csrf
                                    @method('put')
                                    <h6 class="heading-small text-muted mb-4">{{ __('Edit Location Detail') }}</h6>
                                    <div class="pl-lg-4">
                                        <div class="row">
                                            <div class="col-6">
                                        ...
                                        <div class="form-group{{ $errors->has('address') ? ' has-danger' : '' }}">
                                            ...
                                            <textarea name="address" id="input-address" class="form-control form-control-alternative{{ $errors->has('address') ? ' is-invalid' : '' }}" placeholder="{{ __('Address') }}" required >{{ $data->address }}</textarea>
                                        ...
                                        <div class="form-group{{ $errors->has('radius') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="radius" id="input-radius" class="form-control form-control-alternative{{ $errors->has('radius') ? ' is-invalid' : '' }}" placeholder="{{ __('Radius') }}" value="{{ $data->radius }}" required >
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-10">
                                                        <label class="custom-toggle">
                                                            <input type="checkbox" value="1" name="popular" id="popular" {{ $data->popular=="1" ? 'Checked' : ''}}>
